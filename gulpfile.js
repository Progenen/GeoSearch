...
// Versioning html files to reset cache | Версионирования html файлов для сброса кеша
...
function startWatch() {
    ...
    watch(['src/**/*.html'], processHtml);
    watch(['src/**/*.html']).on('change', browserSync.reload);
    watch(['src/svg/stack/mono/*'], series(svgspriteMono, cacheBustTask));
    watch(['src/svg/stack/multi/*'], series(svgspriteMulti, cacheBustTask));
...
function svgspriteMulti() {
    console.log('Creating Multi SVG sprite...');
...
exports.default = series(
    parallel(style, processHtml, scripts, fonts, cleanFonts, svgspriteMono, svgspriteMulti, images, video, cleanImg, browsersync, startWatch),
